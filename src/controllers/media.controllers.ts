...
export const uploadImageController = async (req: Request, res: Response, next: NextFunction) => {
  ...
  console.log(nameCategory, idProduct)

  const result = await mediaServices.uploadImage(files, nameCategory, idProduct)
...
// image/nameDanhMuc/idProduct/1.jpg
// image/nameDanhMuc/idProduct/2.jpg
// image/nameDanhMuc/idProduct/3.jpg
// image/nameDanhMuc/idProduct/4.jpg
